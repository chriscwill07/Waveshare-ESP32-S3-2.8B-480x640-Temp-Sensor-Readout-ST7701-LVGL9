...
**Aside from the README.md, "lv_conf.h" file, and the "tempfont200.c" file, all other provided files will go in sketch folder alongside the TempSensor.ino file.**
